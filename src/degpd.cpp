...
// //' @export
// [[Rcpp::export]]
double degpd1d0(const Rcpp::List& pars, const arma::mat& X1, const arma::mat& X2, const arma::mat& X3, arma::vec yvec, const arma::uvec& dupid, int dcate)
{
...
// //' @rdname degpd1d0
// [[Rcpp::export]]
arma::mat degpd1d12(const Rcpp::List& pars, arma::mat X1, arma::mat X2, arma::mat X3, arma::vec yvec , const arma::uvec dupid, int dcate)
{
...
double degpd2d0(const Rcpp::List& pars, const arma::mat& X1, const arma::mat& X2, const arma::mat& X3, const arma::mat& X4, const arma::mat& X5, arma::vec yvec, const arma::uvec& dupid, int dcate) 
{
  arma::vec lsigmavec = X1 * Rcpp::as<arma::vec>(pars[0]);
  arma::vec lxivec = X2 * Rcpp::as<arma::vec>(pars[1]);
...
// //' @rdname degpd2d0
// [[Rcpp::export]]
arma::mat degpd2d12(const Rcpp::List& pars, arma::mat X1, arma::mat X2, arma::mat X3,  arma::mat X4, arma::mat X5, arma::vec yvec, const arma::uvec dupid, int dcate)
{
...
// //' @export
// [[Rcpp::export]]
double degpd3d0(const Rcpp::List& pars, const arma::mat& X1, const arma::mat& X2, const arma::mat& X3, arma::vec yvec, const arma::uvec& dupid, int dcate)
{
...
// //' @rdname degpd3d0
// [[Rcpp::export]]
arma::mat degpd3d12(const Rcpp::List& pars, arma::mat X1, arma::mat X2, arma::mat X3, arma::vec yvec, const arma::uvec dupid, int dcate)
{
...
double degpd4d0(const Rcpp::List& pars, const arma::mat& X1, const arma::mat& X2, const arma::mat& X3, const arma::mat& X4, arma::vec yvec, const arma::uvec& dupid, int dcate) 
{
  arma::vec lsigmavec = X1 * Rcpp::as<arma::vec>(pars[0]);
  arma::vec lxivec = X2 * Rcpp::as<arma::vec>(pars[1]);
  arma::vec ldeltavec = X3 * Rcpp::as<arma::vec>(pars[2]);
...
// //' @rdname degpd4d0
// [[Rcpp::export]]
arma::mat degpd4d12(const Rcpp::List& pars, arma::mat X1, arma::mat X2, arma::mat X3,  arma::mat X4, arma::vec yvec, const arma::uvec dupid, int dcate)
{
...
// //' Zero-inflated Discrete Extended generalized Pareto distribution of type 2 (zideGPD2) negative log-likelihood
// //'
// //' @param pars a list of vectors of coefficients for each zideGPD parameter
// //' @param X1 a design matrix for the zideGPD log scale parameter
...
// //' @param X6 a design matrix for the zideGPD logit pi 
// //' @param yvec a vector
// //' @param dupid a scalar or vector, identifying duplicates in Xs; -1 corresponds to no duplicates
// //' @return zidegpd1d0 a scalar, the negative log-liklihood
// //' @return zidegpd1d12 a matrix, first then second derivatives w.r.t. zideGPD2 parameters
// //' @return zidegpd1d34 a matrix, third then fourth derivatives w.r.t. zideGPD2 parameters (Not given)
// //' @examples
// //' ## to follow
// //' @export
// [[Rcpp::export]]
...
// //' Zero-inflated Discrete Extended generalized Pareto distribution of type 3 (zideGPD3) negative log-likelihood
// //'
// //' @param pars a list of vectors of coefficients for each zideGPD parameter
// //' @param X1 a design matrix for the zideGPD log scale parameter
...
// //'Zero-inflated Discrete Extended generalized Pareto distribution of type 4 (zideGPD4) negative log-likelihood
// //'
// //' @param pars a list of vectors of coefficients for each zideGPD parameter
// //' @param X1 a design matrix for the zideGPD log scale parameter
// //' @param X2 a design matrix for the zideGPD log shape parameter
